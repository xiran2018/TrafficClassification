...
FRAMEWORK_PROFILES: Dict[str, Dict[str, Any]] = {
    ...
    "paper_unified": {
        ...
        "packet_overrides": {
            ...
            "intervened_embedding_header_policy": "protocol_closed_mixture",
            "intervention_max_residual_weight": 0.25,
            "intervention_view_base_mode": "factual_anchor",
            "use_intervention_views": True,
            "tower1_paired_consistency_mode": "factual_teacher",
            "tower1_paired_group_dro": True,
            "tower1_paired_group_dro_eta": 0.05,
